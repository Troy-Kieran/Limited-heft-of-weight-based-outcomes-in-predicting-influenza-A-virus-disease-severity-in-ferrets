...
2_morbidity2_analysis.R - R code for the primary analyses conducted, including machine learning, elastic net, and linear mixed effects models.

3_morbidity2_figures.R - R code for figures used in the manuscript. 

## Manuscript
Kieran TJ, Maines TR, Belser JA. (Accepted). Limited ‘heft’ of weight-based outcomes in predicting influenza A virus disease severity in ferrets. PLoS Computational Biology. XX(xx), e00000. https://doi.org/10.1371/journal.pcbi.1014210
